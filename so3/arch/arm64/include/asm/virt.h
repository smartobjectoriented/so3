 ...
 */
#define HCR_AGENCY_FLAGS (HCR_VM_MASK | HCR_APL_MASK | HCR_APK_MASK | HCR_RW_MASK)

#define HCR_ME_FLAGS (HCR_VM_MASK | HCR_AMO_MASK | HCR_RW_MASK \
		| HCR_FMO_MASK | HCR_IMO_MASK | HCR_VSE_MASK | HCR_TSC_MASK)
...
#define HCR_HOST_NVHE_FLAGS (HCR_RW_MASK | HCR_APL_MASK | HCR_APK_MASK)
