...
uint8_t sc[] = {
	...
	/* 1 */ 0x00, 0x00, 0x00, 0x00, 0x00, 'q',  '1',  0x00,
	0x00,	      0x00, 'y',  's',	'a',  'w',  '2',  0x00,
	/* 2 */ 0x00, 'c',  'x',  'd',	'e',  '4',  '3',  0x00,
	0x00,	      ' ',  'v',  'f',	't',  'r',  '5',  0x00,
	/* 3 */ 0x00, 'n',  'b',  'h',	'g',  'z',  '6',  0x00,
	0x00,	      0x00, 'm',  'j',	'u',  '7',  '8',  0x00,
	/* 4 */ 0x00, ',',  'k',  'i',	'o',  '0',  '9',  0x00,
	0x00,	      '.',  '-',  'l',	0x00, 'p',  '\'', 0x00,
	/* 5 */ 0x00, 0x00, 0x00, 0x00, 0x00, '^',  0x00, 0x00,
	0x00,	      0x00, '\n', '"',	0x00, '$',  0x00, 0x00,
	/* 6 */ 0x00, '<',  0x00, 0x00, 0x00, 0x00, 0x08, 0x00,
	0x00,	      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	/* 7 */ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1b, 0x00,
	0x00,	      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
uint8_t scs[] = {
	...
	/* 0 */ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00,	      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	/* 1 */ 0x00, 0x00, 0x00, 0x00, 0x00, 'Q',  '+',  0x00,
	0x00,	      0x00, 'Y',  'S',	'A',  'W',  '"',  0x00,
	/* 2 */ 0x00, 'C',  'X',  'D',	'E',  0x00, '*',  0x00,
	0x00,	      ' ',  'V',  'F',	'T',  'R',  '%',  0x00,
	/* 3 */ 0x00, 'N',  'B',  'H',	'G',  'Z',  '&',  0x00,
	0x00,	      0x00, 'M',  'J',	'U',  '/',  '(',  0x00,
	/* 4 */ 0x00, ';',  'K',  'I',	'O',  '=',  ')',  0x00,
	0x00,	      ':',  '_',  'L',	0x00, 'P',  '?',  0x00,
	/* 5 */ 0x00, 0x00, 0x00, 0x00, 0x00, '`',  0x00, 0x00,
	0x00,	      0x00, 0x00, '!',	0x00, 0x00, 0x00, 0x00,
...
uint8_t sce[] = {
	...
	/* 7 */ 0x00, 0x7f, 0x12, 0x00, 0x13, 0x11, 0x00, 0x00,
	0x00,	      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	/* 8 */ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00,	      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	/* 9 */ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void get_mouse_state(uint8_t *packet, struct ps2_mouse *state, uint16_t max_x,
		     uint16_t max_y)
{
	/* Discard packet if there are overflows, as advised. */
	if ((packet[PS2_STATE] & AO) && ~(packet[PS2_STATE] & Y_OF) &&
		...
		DBG("sign_dxy[%s, %s], dxy_val[%03u, %03u], computed_dxy[%03d, %03d]; xy[%03d, %03d]; %03s %03s %03s\n",
		    ...
		    packet[PS2_STATE] & Y_BS ? "neg" : "pos", packet[PS2_X],
		    packet[PS2_Y], GET_DX(packet[PS2_STATE], packet[PS2_X]),
		    GET_DY(packet[PS2_STATE], packet[PS2_Y]), state->x,
		    state->y, state->left ? "LFT" : "",
		    state->middle ? "MID" : "", state->right ? "RGT" : "");
	} else {
