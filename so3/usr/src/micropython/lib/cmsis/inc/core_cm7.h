...
typedef struct {
	...
	__IOM uint32_t IABR
		[8U]; /*!< Offset: 0x200 (R/W)  Interrupt Active bit Register */
...
#define SCB_CCR_BP_Msk \
	(1UL           \
	 << SCB_CCR_BP_Pos) /*!< SCB CCR: Branch prediction enable bit Mask */

#define SCB_CCR_IC_Pos \
	17U /*!< SCB CCR: Instruction cache enable bit Position */
#define SCB_CCR_IC_Msk \
	(1UL           \
	 << SCB_CCR_IC_Pos) /*!< SCB CCR: Instruction cache enable bit Mask */
...
#define SCB_CFSR_IMPRECISERR_Msk \
	(1UL                     \
	 << SCB_CFSR_IMPRECISERR_Pos) /*!< SCB CFSR (BFSR): IMPRECISERR Mask */
...
#define SCnSCB_ACTLR_DISCRITAXIRUR_Msk \
	(1UL                           \
	 << SCnSCB_ACTLR_DISCRITAXIRUR_Pos) /*!< ACTLR: DISCRITAXIRUR Mask */
...
__STATIC_FORCEINLINE void SCB_CleanDCache(void)
{
	...
	do {
		ways = (uint32_t)(CCSIDR_WAYS(ccsidr));
		do {
			SCB->DCCSW = (((sets << SCB_DCCSW_SET_Pos) &
				       SCB_DCCSW_SET_Msk) |
...
#if defined(__DCACHE_PRESENT) && (__DCACHE_PRESENT == 1U)
	if (dsize > 0) {
		int32_t op_size = dsize + (((uint32_t)addr) &
