...
#define VTCR_CELL                                                                                                            \
	(T0SZ_CELL | (SL0_CELL << TCR_SL0_SHIFT) | (TCR_RGN_WB_WA << TCR_IRGN0_SHIFT) | (TCR_RGN_WB_WA << TCR_ORGN0_SHIFT) | \
	 (TCR_INNER_SHAREABLE << TCR_SH0_SHIFT) | (5 << TCR_PS_SHIFT) | VTCR_RES1)
