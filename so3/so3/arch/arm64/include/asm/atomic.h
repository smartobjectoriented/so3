...
#define __CMPXCHG_CASE(w, sz, name)                                                                                       \
	static inline bool __cmpxchg_case_##name(volatile void *ptr, unsigned long *old, unsigned long new, bool timeout, \
...
static inline bool __int_cmpxchg(volatile void *ptr, unsigned long *old, unsigned long new, int size, bool timeout,
				 unsigned int max_try)
{
	switch (size) {
	case 1:
 ...
 */
static always_inline bool __cmpxchg_timeout(volatile void *ptr, unsigned long *old, unsigned long new, int size,
					    unsigned int max_try)
{
	bool ret;
