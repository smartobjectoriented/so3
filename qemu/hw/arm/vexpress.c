                                   ...
                                   qemu_irq *pic)
{
    ...
    memory_region_init_ram(sram, NULL, "vexpress.a15sram", 0x01000000,
                           &error_fatal);
...
static void vexpress_common_init(MachineState *machine)
{
    ...
    pflash0 = ve_pflash_cfi01_register(map[VE_NORFLASH0], "vexpress.flash0", NULL);
    ...
    if (bios_name) {
        ...
        image_size = load_image_mr(fn, flash0mem);
        g_free(fn);
        if (image_size < 0) {
