...
/* SOO.tech */
/* Used to check if the download has started. Otherwise,
 * get out from the fastboot mode after a delay.
 * (see board/sunxi/board.c)
 */
char fastboot_dl_in_progress = 0;
